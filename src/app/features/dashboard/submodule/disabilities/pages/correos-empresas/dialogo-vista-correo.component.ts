...
@Component({
  ...
  styles: [`
    ...
    .vc-cabecera dt { color: var(--muted); font-weight: 600; }
    .vc-cabecera dd { margin: 0; word-break: break-word; }
    .vc-marco { width: 100%; height: min(60vh, 560px); border: 1px solid rgb(var(--ink-rgb) / 0.12); border-radius: 10px; background: var(--surface); }
  `],
})
