...
@Component({
  ...
  styles: [`
    ...
    .sst-persona { margin: 0 0 8px; font-size: 13px; color: var(--text-2); }
    .sst-error { display: flex; align-items: center; gap: 6px; color: #c62828; color: light-dark(#c62828, #eca2a2); margin: 0; font-size: 13px; }
  `],
})
